...
Describe 'Negative Parsing Tests' -Tags "CI" {
    ...
    ShouldBeParseError 'interface IFoo { static $x; }' AbstractTypesCantHaveStaticMembers 24
    ...
    ShouldBeParseError 'interface I { static C($x) }' AbstractTypesCantHaveStaticMembers 24 -SkipAndCheckRuntimeError
    ShouldBeParseError 'interface I { static C([int]$x = 100) }' AbstractTypesCantHaveStaticMembers 24 -SkipAndCheckRuntimeError
